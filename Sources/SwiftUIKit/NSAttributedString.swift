...
extension NSMutableAttributedString {
    ...
    @discardableResult
    public func foregroundColor(_ color: UIColor, loc: Int, len: Int) -> Self {
    ...
    @discardableResult
    public func font(_ font: UIFont, loc: Int, len: Int) -> Self {
    ...
    @discardableResult
    public func baselineOffset(_ offset: CGFloat, loc: Int, len: Int) -> Self {
    ...
    @discardableResult
    public func kern(_ kern: CGFloat, loc: Int, len: Int) -> Self {
    ...
    @discardableResult
    public func lineHeight(_ height: CGFloat, loc: Int, len: Int) -> Self {
